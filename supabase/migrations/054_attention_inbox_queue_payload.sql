-- Expose queue payload metadata in the daily attention inbox.
-- The UI uses this for internal CRM context such as missed/cancelled meeting follow-ups.
...
LANGUAGE sql STABLE SECURITY DEFINER SET search_path = public AS $$
  WITH q AS (
    SELECT
      ...
      COALESCE(w.payload_json, '{}'::jsonb) AS payload_json,
      l.last_inbound_at,
      l.last_outbound_at,
      w.priority_level,
