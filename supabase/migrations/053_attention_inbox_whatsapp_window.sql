-- Expose lead WhatsApp conversation timestamps in the daily attention inbox.
-- The UI uses these fields to explain whether reps can send freeform WhatsApp
-- replies now or whether the message will be queued until the customer replies / an approved template exists.
