...
Deno.serve(async (req) => {
  ...
  // Fail-closed: WHATSAPP_APP_SECRET must be set AND header must be present.
  // Previously the check was skipped silently if either was missing — an
  // attacker could omit the signature header to bypass verification entirely.
