...
const transitions: Record<LeadStatus, LeadStatus[]> = {
  ...
  qualified: ['checkout_pushed', 'human_handoff', 'nurture', 'lost', 'do_not_contact', 'removed_by_request'],
  ...
  human_handoff: ['responded', 'qualified', 'checkout_pushed', 'payment_pending', 'won', 'nurture', 'lost', 'do_not_contact', 'removed_by_request'],
