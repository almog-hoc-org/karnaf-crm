// Pure decision logic for orchestrate-message's "already answered"
// coalescing guard. Mirrored at lib/runtime/answered-guard.ts — keep in
// sync (this file must stay dependency-free).
//
